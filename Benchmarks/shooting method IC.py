...
shear_core_0 = 0.
shear_core_1 = 6.68250e-10
shear_core_2 = 6.68250e-10
...
R_IC_m1 = 0.5 * R_core_m1
R_IC_m2 = 0.5 * R_core_m2
...
density_array_m1[radius_array <= R_core_m1] = rho_core_liq
density_array_m1[radius_array <= R_IC_m1] = rho_IC
density_array_m2 = rho_mantle * np.ones_like(radius_array)
density_array_m2[radius_array <= R_core_m2] = rho_core_liq
density_array_m2[radius_array <= R_IC_m2] = rho_IC
...
for structure_name, deriv_func in (('HG', deriv_m0), ('LC0', deriv_m1), ('LC1', deriv_m2)):
    ...
    solution = solve_bvp(deriv_func, bc_residual, radii, initial_guess, max_nodes=100000, tol=1e-2, verbose=2)
...
ax_y3 = axes_tidal_y[0, 1]
ax_y2 = axes_tidal_y[0, 2]
...
ax_y5.set(ylabel='Radius [km]', xlabel='$y_{5}$')
ax_y6.set(ylabel='Radius [km]', xlabel='$y_{6}$')
...
for model_name, model_ls in line_style_by_model.items():
    ...
    ax_y5.plot((tidal_y_set[4, :]), radii/1000., label=model_name, c='k', ls=model_ls)
    ax_y6.plot((tidal_y_set[5, :]), radii/1000., label=model_name, c='k', ls=model_ls)
