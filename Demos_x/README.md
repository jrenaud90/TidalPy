...
8. `08_love_numbers_1d`: the 1D radial solver for global Love numbers of multi-layer terrestrial worlds, and how static vs dynamic and compressible vs incompressible assumptions change them.
