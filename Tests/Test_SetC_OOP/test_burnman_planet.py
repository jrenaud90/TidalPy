...
def test_build_planet_from_dict():
    ...
    result = TidalPy.build_planet('Io', planet_config=io_config, force_build=True)
...
def test_build_planet_from_json():
    ...
    with open('temp_io.json', 'r') as planet_file:
        result = TidalPy.build_planet('Io', planet_config=planet_file, force_build=True)
...
def test_build_planet_from_tidalpy():
    ...
    result = TidalPy.build_planet('Io', force_build=True)
