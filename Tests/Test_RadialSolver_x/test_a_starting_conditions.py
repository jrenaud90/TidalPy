...
# Pre-calculated results from TidalPy 0.5 (same as original RadialSolver tests).
# Known results updated during TidalPy v0.7.2 because of an error found in takeuchi initial conditions.
known_results_tpy0p5 = {
    ...
    (True, True, False, False, 2):
        np.asarray((
            ...
            -4.21355678e+05-1.66936951e-03j, -2.10677839e+07-8.34684753e-02j,
            ...
            2.78498535e+05+9.55083791e-04j,  1.39249267e+07+4.77541895e-02j,
    ...
    (True, True, False, False, 3):
        np.asarray((
            ...
            -6.16660684e+04-2.43720768e-04j, -4.31662479e+06-1.70604538e-02j,
            ...
            3.30946399e+04+1.00863625e-04j,  2.31662479e+06+7.06045378e-03j,
    ...
    # Kamata dynamic incompressible solid: solution 1 is (s1 - s2) gamma / omega^2 since 2026-09-23, which keeps the
    # basis independent at low frequency (the original s1 and s2 converge as omega -> 0); solutions 2 and 3 as before.
    (True, False, True, True, 2):
        np.asarray((
            0.00000000e+00 + 0.00000000e+00j, -7.00313121e+01 + -2.61301747e-23j,
            3.91401394e-15 + -1.95700697e-23j, 9.78503486e-03 + 4.35502912e-24j,
            1.00019570e-02 + 0.00000000e+00j, 5.00097850e-01 + 0.00000000e+00j,
    ...
    (True, False, True, True, 3):
        np.asarray((
            0.00000000e+00 + 0.00000000e+00j, -7.00182654e+01 + -2.58298279e-23j,
            3.04423307e-15 + -1.52211653e-23j, 1.06548157e-02 + 2.15248566e-24j,
            1.00000000e-02 + 0.00000000e+00j, 7.00000000e-01 + 0.00000000e+00j,
    ...
    (True, False, False, False, 2):
        np.asarray((
            ...
            -8.51569329e+08-6.07958352e-01j, -4.25784665e+10-3.03979176e+01j,
            ...
            -2.14165857e+05-1.07067501e-03j, -1.07082929e+07-5.35337506e-02j,
            2.00000000e-01+0.00000000e+00j,  2.00000000e+11+1.00000000e+03j,
            1.00000000e-01+0.00000000e+00j,  1.00000000e+11+5.00000000e+02j,
    ...
    (True, False, False, False, 3):
        np.asarray((
            ...
            -8.51640878e+07-6.08316249e-02j, -5.96148614e+09-4.25821374e+00j,
            ...
            -2.85474572e+04-1.42706431e-04j, -1.99832200e+06-9.98945018e-03j,
            3.00000000e-02+0.00000000e+00j,  6.00000000e+10+3.00000000e+02j,
            1.00000000e-02+0.00000000e+00j,  2.00000000e+10+1.00000000e+02j,
...
def test_initial_condition_accuracy(layer_type, is_static, is_incompressible, use_kamata, degree_l):
    ...
    if (is_solid, is_static, is_incompressible, use_kamata, degree_l) not in known_results:
        pytest.skip(f'Combination not found in pre-calculated TidalPy results.')
    elif known_results[(is_solid, is_static, is_incompressible, use_kamata, degree_l)] is None:
        pytest.skip(f'Combination not implemented in pre-calculated TidalPy results.')
    else:
