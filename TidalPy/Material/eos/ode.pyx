...
cdef void eos_solution(
    ...
    if eos_input_ptr.final_solve:
        ...
        dy_ptr[3] = eos_output.static_shear_modulus
        dy_ptr[4] = eos_output.shear_viscosity
        dy_ptr[5] = eos_output.shear_modulus.real
        dy_ptr[6] = eos_output.shear_modulus.imag

        dy_ptr[7] = eos_output.static_bulk_modulus
        dy_ptr[8] = eos_output.bulk_viscosity
        dy_ptr[9] = eos_output.bulk_modulus.real
        dy_ptr[10] = eos_output.bulk_modulus.imag
