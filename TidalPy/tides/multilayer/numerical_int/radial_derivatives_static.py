...
#                                      gravity : FloatArray, order_l: int = 2) -> RadialFuncSolidType:
...
#                                 shear_modulus: CmplxFltArray, bulk_modulus: CmplxFltArray, density: FloatArray,
#                                 gravity: FloatArray) -> RadialFuncSolidType:
...
#         y1 * (density * gravity * r_inverse - 6. * bulk_modulus * shear_modulus * lame_2mu * r2_inverse) - \
#         y2 * lame * lame_2mu * r_inverse + \
#         y3 * (24. * (lame + shear_modulus) * shear_modulus * lame_2mu * r2_inverse - 2. * shear_modulus * r2_inverse) -\
#         y4 * 3. * r_inverse - \
#         y5 * density * r_inverse
#
#     dy5 = \
...
@njit(cacheable=True)
def radial_derivatives_liquid_l2(radius: FloatArray, radial_functions: RadialFuncLiquidStaticType,
                                 density: FloatArray, gravity: FloatArray) -> RadialFuncLiquidStaticType:
    ...
    # See Eq. 18 in S75
    dy5 = \
        y5 * (grav_term / gravity - 3. * r_inverse) + \
        y7

    dy7 = \
        y5 * 2. * r_inverse * grav_term / gravity + \
        y7 * (r_inverse - grav_term / gravity)
