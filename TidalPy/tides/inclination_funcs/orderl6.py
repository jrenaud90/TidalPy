...
def calc_inclination(inclination: FloatArray) -> InclinOutput:
    ...
    inclination_results = {
        ...
        (0, 2): 43.06640625 * (
                    -24.0 * sin_i_half**10 + 62.0 * sin_i_half**8 - 53.0 * sin_i_half**6 + 15.0 * sin_i_half**4 + 9.0 * cos_i_half**10 - 8.0 * cos_i_half**8)**2 * sin_i_half**4,
        (0, 3): 0.09765625 * (
                    262.0 * sin_i_half**12 - 486.0 * sin_i_half**10 + 225.0 * sin_i_half**8 - 400.0 * sin_i_half**6 * cos_i_half**6 + 225.0 * sin_i_half**4 * cos_i_half**8 + 37.0 * cos_i_half**12 - 36.0 * cos_i_half**10)**2,
        (0, 4): 43.06640625 * (
                    -24.0 * sin_i_half**10 + 62.0 * sin_i_half**8 - 53.0 * sin_i_half**6 + 15.0 * sin_i_half**4 + 9.0 * cos_i_half**10 - 8.0 * cos_i_half**8)**2 * sin_i_half**4,
        ...
        (1, 2): (-0.205078125 * (
                    cos_i + 1.0)**5 * sin_i - 91.875 * sin_i_half**9 * cos_i_half**3 + 459.375 * sin_i_half**7 * cos_i_half**5 - 551.25 * sin_i_half**5 * cos_i_half**7 + 183.75 * sin_i_half**3 * cos_i_half**9)**2,
        (1, 3): (0.205078125 * (
                    cos_i + 1.0)**5 * sin_i - 13.125 * sin_i_half**11 * cos_i_half + 196.875 * sin_i_half**9 * cos_i_half**3 - 656.25 * sin_i_half**7 * cos_i_half**5 + 656.25 * sin_i_half**5 * cos_i_half**7 - 196.875 * sin_i_half**3 * cos_i_half**9)**2,
        (1, 4): 172.265625 * (
                    57.0 * sin_i_half**8 - 98.0 * sin_i_half**6 + 42.0 * sin_i_half**4 + 42.0 * cos_i_half**8 - 35.0 * cos_i_half**6)**2 * sin_i_half**6 * cos_i_half**2,
        ...
        (2, 1): 0.09462833404541015625 * (cos_i + 1.0)**6 * (
                    -191.0 * cos_i + 110.0 * cos_i_double - 33.0 * cos_i_triple + 114.0)**2,
        (2, 2): 172.265625 * (42.0 * (
                    cos_i - 1.0)**2 + 462.0 * sin_i_half**8 - 560.0 * sin_i_half**6 + 33.0 * cos_i_half**8 - 32.0 * cos_i_half**6)**2 * cos_i_half**8,
        (2, 3): 68906.25 * (
                    -24.0 * sin_i_half**10 + 62.0 * sin_i_half**8 - 53.0 * sin_i_half**6 + 15.0 * sin_i_half**4 + 9.0 * cos_i_half**10 - 8.0 * cos_i_half**8)**2 * sin_i_half**4,
        (2, 4): 172.265625 * (
                    201.0 * sin_i_half**8 - 368.0 * sin_i_half**6 + 168.0 * sin_i_half**4 + 294.0 * cos_i_half**8 - 224.0 * cos_i_half**6)**2 * sin_i_half**8,
        ...
        (3, 1): (-7.3828125 * (
                    cos_i + 1.0)**5 * sin_i - 5670.0 * sin_i_half**5 * cos_i_half**7 + 4252.5 * sin_i_half**3 * cos_i_half**9)**2,
        (3, 2): (7.3828125 * (
                    cos_i + 1.0)**5 * sin_i - 6615.0 * sin_i_half**7 * cos_i_half**5 + 13230.0 * sin_i_half**5 * cos_i_half**7 - 5670.0 * sin_i_half**3 * cos_i_half**9)**2,
        (3, 3): 155039.0625 * (
                    11.0 * sin_i_half**4 - 11.0 * sin_i_half**2 + 2.0)**2 * sin_i_half**4 * sin_i_double**2 * cos_i_half,
        (3, 4): 223256.25 * (
                    -41.0 * sin_i_half**6 + 68.0 * sin_i_half**4 - 28.0 * sin_i_half**2 + 14.0 * cos_i_half**6)**2 * sin_i_half**10 * cos_i_half**2,
        ...
        (4, 2): 85.165500640869140625 * (cos_i + 1.0)**6 * (
                    -191.0 * cos_i + 110.0 * cos_i_double - 33.0 * cos_i_triple + 114.0)**2,
