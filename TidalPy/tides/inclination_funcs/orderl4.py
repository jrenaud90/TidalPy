...
def calc_inclination(inclination: FloatArray) -> InclinOutput:
    ...
    inclination_results = {
        ...
        (0, 2): 0.140625 * (
                    53.0 * sin_i_half**8 - 88.0 * sin_i_half**6 + 36.0 * sin_i_half**4 + 17.0 * cos_i_half**8 - 16.0 * cos_i_half**6)**2,
        ...
        (1, 1): (-0.46875 * (
                    cos_i + 1.0)**3 * sin_i - 25.0 * sin_i_half**5 * cos_i_half**3 + 37.5 * sin_i_half**3 * cos_i_half**5)**2,
        (1, 2): (0.46875 * (
                    cos_i + 1.0)**3 * sin_i - 7.5 * sin_i_half**7 * cos_i_half + 45.0 * sin_i_half**5 * cos_i_half**3 - 45.0 * sin_i_half**3 * cos_i_half**5)**2,
