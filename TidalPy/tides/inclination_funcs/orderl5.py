...
def calc_inclination(inclination: FloatArray) -> InclinOutput:
    ...
    inclination_results = {
        ...
        (0, 2): (-0.05859375 * (
                    cos_i + 1.0)**4 * sin_i - 1.875 * sin_i_half**9 * cos_i_half + 18.75 * sin_i_half**7 * cos_i_half**3 - 37.5 * sin_i_half**5 * cos_i_half**5 + 18.75 * sin_i_half**3 * cos_i_half**7)**2,
        (0, 3): (0.05859375 * (
                    cos_i + 1.0)**4 * sin_i + 1.875 * sin_i_half**9 * cos_i_half - 18.75 * sin_i_half**7 * cos_i_half**3 + 37.5 * sin_i_half**5 * cos_i_half**5 - 18.75 * sin_i_half**3 * cos_i_half**7)**2,
        ...
        (1, 1): 0.01051425933837890625 * (cos_i + 1.0)**4 * (
                    -65.0 * cos_i + 42.0 * cos_i_double - 15.0 * cos_i_triple + 38.0)**2,
        (1, 2): 3.515625 * (
                    -185.0 * sin_i_half**10 + 445.0 * sin_i_half**8 - 350.0 * sin_i_half**6 + 90.0 * sin_i_half**4 + 25.0 * cos_i_half**10 - 24.0 * cos_i_half**8)**2,
        (1, 3): 3.515625 * (
                    115.0 * sin_i_half**8 - 204.0 * sin_i_half**6 + 90.0 * sin_i_half**4 + 95.0 * cos_i_half**8 - 80.0 * cos_i_half**6)**2 * sin_i_half**4,
        ...
        (2, 1): (-1.640625 * (
                    cos_i + 1.0)**4 * sin_i - 367.5 * sin_i_half**5 * cos_i_half**5 + 367.5 * sin_i_half**3 * cos_i_half**7)**2,
        (2, 2): (1.640625 * (
                    cos_i + 1.0)**4 * sin_i - 262.5 * sin_i_half**7 * cos_i_half**3 + 787.5 * sin_i_half**5 * cos_i_half**5 - 472.5 * sin_i_half**3 * cos_i_half**7)**2,
        (2, 3): 2756.25 * (
                    -25.0 * sin_i_half**6 + 39.0 * sin_i_half**4 - 15.0 * sin_i_half**2 + 5.0 * cos_i_half**6)**2 * sin_i_half**6 * cos_i_half**2,
        ...
        (3, 2): 6.05621337890625 * (cos_i + 1.0)**4 * (
                    -65.0 * cos_i + 42.0 * cos_i_double - 15.0 * cos_i_triple + 38.0)**2,
