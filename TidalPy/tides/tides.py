...
class TidesBase(WorldConfigHolder):
    ...
    The base class is used for non-layered planets (Gas Giants, Stars, Very simple homogeneous planets)
...
class LayeredTides(TidesBase):
    ...
    def __init__(self, world: 'TidalWorldType', store_config_in_world: bool = True):
        ...
        # FIXME: Once the order-6 and order-7 e^20 are done
        if self.tidal_order_lvl in [6, 7] and self.eccentricity_truncation_lvl == 20:
            raise NotImplementedError('These are currently being calculated! Not in yet...')
