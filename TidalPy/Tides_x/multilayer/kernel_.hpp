        ...
        c_Tensor6& stress_out) noexcept
{
    ...
    // Angular helper combinations.
    const double s2_t1 = (sin_inv * sin_inv) * P.d2U_dphi2 + cot_theta * P.dU_dtheta;
    const double s4_t0 = P.dU_dphi * sin_inv;
    const double s5_t0 = 2.0 * (P.d2U_dtheta_dphi - cot_theta * P.dU_dphi) * sin_inv;
