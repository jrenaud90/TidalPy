...
def calculate_sls(radius: np.ndarray, shear_modulus: np.ndarray, bulk_modulus: np.ndarray,
    ...
    tidal_y_derivative[:, layer_2_indx] = \
        np.stack(radial_derivative_layer_2(radius[layer_2_indx], tidal_y[:, layer_2_indx]))
    ...
    if layer_1_static:
        ...
        liq_derivatives = np.stack(radial_derivative_layer_1(radius[layer_1_indx], tidal_y_liq))
