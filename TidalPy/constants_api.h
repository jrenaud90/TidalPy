...
static int import_TidalPy__constants(void) {
  ...
  if (!module) goto bad;
  if (__Pyx_ImportFunction_3_2_5(module, "get_shared_config_address", (void (**)(void))&__pyx_api_f_7TidalPy_9constants_get_shared_config_address, "TidalPyConfig *(void)") < 0) goto bad;
