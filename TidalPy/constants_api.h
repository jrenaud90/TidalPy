...
#ifndef __PYX_HAVE_API__TidalPy__constants
#define __PYX_HAVE_API__TidalPy__constants
#ifdef __MINGW64__
#define MS_WIN64
#endif
#include "Python.h"

static TidalPyConfig *(*__pyx_api_f_7TidalPy_9constants_get_shared_config_address)(void) = 0;
#define get_shared_config_address __pyx_api_f_7TidalPy_9constants_get_shared_config_address
...
static int import_TidalPy__constants(void) {
  PyObject *module = 0;
  module = PyImport_ImportModule("TidalPy.constants");
  if (!module) goto bad;
  if (__Pyx_ImportFunction_3_2_4(module, "get_shared_config_address", (void (**)(void))&__pyx_api_f_7TidalPy_9constants_get_shared_config_address, "TidalPyConfig *(void)") < 0) goto bad;
...
#endif /* !__PYX_HAVE_API__TidalPy__constants */
