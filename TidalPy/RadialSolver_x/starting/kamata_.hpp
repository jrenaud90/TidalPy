...
// Calculate the starting guess at the bottom of a solid layer using the static assumption: KMN15 Eqs. B1-B16
// with w = 0, which is the dynamic form at zero frequency.
// Three independent solutions (sn1, sn2, sn3).
