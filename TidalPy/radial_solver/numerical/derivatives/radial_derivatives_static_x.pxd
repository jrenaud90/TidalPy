...
cdef void dy_liquid_static_compressible_x(double radius, double[:] radial_functions, double[:] dy, double bulk_modulus, double density, double gravity, unsigned int degree_l = *, double G_to_use = *) nogil
